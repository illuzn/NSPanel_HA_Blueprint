...
- **Getting Started:** Dive into our comprehensive [Documentation and Setup Guide](get_started.md) for detailed instructions.
- **Video Tutorial:** Prefer visual learning? Check out our [Step-by-Step Setup Video](get_started.md#video).
- **Troubleshooting:** Encounter an issue? Here's how to report it: [WIKI HowTo](troubleshooting.md).
...
- Thermostat + Touch + [Relay control for floor heating](addon_climate.md)
...
![Entities EU](pics/eu_entities.png)

![Entities US](pics/us_entities.png)
...
- [Can be used for local control (even when Wi-Fi is unavailable) when your panel's relays are used to control your cooler/heater](addon_climate.md)
...
![Device Setting - Controls](pics/ha_device_controls.png)

![Device Setting - Sensors](pics/ha_device_sensors.png)

![Device Setting - Configuration](pics/ha_device_configuration.png)

![Device Setting - Diagnostic](pics/ha_device_diagnostic.png)
